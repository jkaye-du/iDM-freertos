...
AMAZON_FREERTOS_ROOT := $(PROJECT_ROOT)/amazon-freertos

AMAZON_FREERTOS_SDK_DIR := $(AMAZON_FREERTOS_ROOT)/libraries/c_sdk
AMAZON_FREERTOS_3RD_PARTY_DIR := $(AMAZON_FREERTOS_ROOT)/libraries/3rdparty
AMAZON_FREERTOS_ABSTRACTIONS_DIR := $(AMAZON_FREERTOS_ROOT)/libraries/abstractions
...
AMAZON_FREERTOS_ESP32 := $(PROJECT_PATH)/esp32/aws_tests
endif
